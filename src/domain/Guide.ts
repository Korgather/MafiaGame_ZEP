 ...
 *
 * 초 단위 숫자를 한 글자도 적지 않았다. TIMING을 조정하는 순간 이 문장이
...
/**
 * 직업 도감 12장. 마피아 팀이 먼저 오고 시민 팀이 뒤따른다.
 *
 * 마피아를 앞에 두는 이유는 처음 보는 사람이 가장 먼저 궁금해하는 것이
 * "적이 무엇을 할 수 있는가"이기 때문이다. 시민 직업 아홉 장을 넘긴 뒤에야
 * 마피아가 나오면 정작 알아야 할 것을 못 보고 닫는다.
 *
