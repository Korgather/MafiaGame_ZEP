 ...
 *
 * 이 파일이 하는 일은 둘이다.
 *   1. 게임 규칙과 첫 행동을 4장으로 요약한 첫 안내 카드 (GUIDE_CARDS)
 ...
 * 첫 안내 4장.
 *
 * 처음 세 장은 목표 / 진행 흐름 / 화면 읽기를 설명하고, 마지막 한 장은
 * 첫 판에서 실제로 누를 행동을 체크리스트처럼 이어 준다.
...
export const GUIDE_CARDS: readonly CardView[] = [
	...
	{
		glyph: "✅",
		title: "첫 판은 이것만 기억하세요",
		team: null,
		body: "방에서 준비를 누르고 직업 카드를 확인하세요. 밤에는 화면의 지시에 따라 행동하고, 낮에는 채팅으로 단서를 나눈 뒤 의심되는 사람에게 투표합니다.",
		summary: "",
		note: "게임 방법은 대기실 버튼이나 /규칙, 직업 설명은 📖 버튼이나 /도감으로 언제든 다시 볼 수 있습니다.",
	},
];
 ...
 * "적이 무엇을 할 수 있는가"이기 때문이다. 시민 쪽이 열여섯 장이라, 그것을 다
